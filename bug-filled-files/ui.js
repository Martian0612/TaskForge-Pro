...
export function handleModalFormData() {
    const form = document.getElementById("task-form");
    let dueDateVal = form["modal-dueDate"].value;
    if (!dueDateVal || dueDateVal.trim() === "") dueDateVal = null;
...
export function populateModalForm(taskData) {
    ...
    //         console.log("date in taskData was ", date);
    ...
    // Updated version for adding a clear button 
    // const fp = form["modal-dueDate"]._flatpickr;
    // if (fp) {
    //     if (taskData.dueDate) {
    //         try {
    //             const date = taskData.dueDate instanceof Date
    ...
    //             if (!isNaN(date.getTime())){
    //                 fp.setDate(date, true); // true = trigger change events
    //             } else {
    //                 fp.clear();
    //             }
    //         } catch(error){
    ...
    //         fp.clear();
    //     }
    //     // Sync clear icon if you have it
    //     if (window.toggleClearBtn) toggleClearBtn();
    // }
    // if (fp) {
    //     if (taskData.dueDate && !isNaN(new Date(taskData.dueDate).getTime())) {
    //         fp.setDate(new Date(taskData.dueDate), true);
    //     } else {
    //         fp.clear();
    //     }
    //     if (window.toggleClearBtn) window.toggleClearBtn();
    // }
